...
public class SessionServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        List<Session> adminupcomingSessions = new ArrayList<>();
        List<Session> adminpastSessions = new ArrayList<>();
        ...
        try {
            ...
            try (Statement stmt = conn.createStatement(); ResultSet rs = stmt.executeQuery(queryUpcoming)) {
                while (rs.next()) {
                    ...
                    adminupcomingSessions.add(session);
                }
            }
        ...
        request.setAttribute("adminupcomingSessions", adminupcomingSessions);
        request.setAttribute("adminpastSessions", adminpastSessions);
